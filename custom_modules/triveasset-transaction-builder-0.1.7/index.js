...
TriveAssetBuilder.prototype.buildIssueTransaction = function (args) {
  ...
  var txb = new bitcoinjs.TransactionBuilder(self.network === 'testnet' ? bitcoinjs.networks.trivecointestnet : bitcoinjs.networks.trivecoin)
...
TriveAssetBuilder.prototype._addInputsForIssueTransaction = function (txb, args) {
  var self = this
...
TriveAssetBuilder.prototype._encodeAssetId = function (reissueable, txid, nvout, hex, divisibility, aggregationPolicy) {
  var opts = {
    ccdata: [{
      type: 'issuance',
...
TriveAssetBuilder.prototype._insertSatoshiToTransaction = function (utxos, txb, missing, inputsValue, metadata) {
...
TriveAssetBuilder.prototype._tryAddingInputsForFee = function (txb, utxos, totalInputs, metadata, satoshiCost) {
  var self = this
...
TriveAssetBuilder.prototype._getChangeAmount = function (tx, fee, totalInputValue) {
