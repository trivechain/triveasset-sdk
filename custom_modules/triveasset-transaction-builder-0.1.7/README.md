# triveasset-transaction-builder
...
TriveAsset Transaction Builder.<br>
This module is a high-level abstraction for building transactions for issuing and transferring digital assets using the TriveAsset protocol.
...
```sh
npm install triveasset-transaction-builder
```

## Usage

```js
var TriveAssetBuilder = require('triveasset-transaction-builder')
var ccb = new TriveAssetBuilder()
...
### `builder = TriveAssetBuilder([properties])`

Create a new `TriveAssetBuilder` instance.
...
[npm-image]: https://badge.fury.io/js/triveasset-transaction-builder.svg
[npm-url]: https://npmjs.org/package/triveasset-transaction-builder
[travis-image]: https://travis-ci.org/Colored-Coins/triveasset-transaction-builder.svg?branch=master
[travis-url]: https://travis-ci.org/Colored-Coins/triveasset-transaction-builder
[slack-image]: http://slack.triveassets.org/badge.svg
[slack-url]: http://slack.triveassets.org
